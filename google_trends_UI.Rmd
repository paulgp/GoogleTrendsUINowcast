...
policy_search_lf <-policy_search_lf %>% 
  pivot_longer(
...
ggplot(policy_search_lf, aes(x = days, y = hits, group = type, color = type)) +
  geom_line() + 
  scale_color_manual(labels = c("Complete", "Partial"), values = c("cadetblue3", "mediumpurple2")) + 
